...
<body>
    ...
    <div class="content">
        ...
        <div class="user-info">
            <div>
                <p><?php echo $_SESSION["name"]; ?> <span
                        style="color:gray; text-transform:none;font-weight:normal">(Candidate no.
                        <?php echo $_SESSION["nameCandidate"]; ?>)</span></p>
                <p><?php echo $_SESSION["address"]; ?> <span
                        style="color:gray;text-transform:none;font-weight:normal">(Centre no.
                        <?php echo $_SESSION["addressCandidate"]; ?>)</span></p>

            </div>
            <div>
                <button style="border:#90abb9 1px solid;background-color:#c1e0f8;width: 80px; height: 30px;"> <a
                        class="a" href="index.php"> <span>



                            <svg style="background-color:#4667a3;border-radius:20px;padding:1px 2px;margin-right:6px;margin-top:3px"
                                fill='white' xmlns="http://www.w3.org/2000/svg" height="0.8em" viewBox="0 0 384 512">
        ...
        <div style="display: flex; justify-content:space-between">
            ...
            <p style="font-size: smaller;margin-left:20px;font-weight:bold;color:#84b6d0"> <span><svg fill='#84b6d0'
        ...
        <div style="display: flex;justify-content:end">
            <button style="border:#90abb9 1px solid;background-color:#c1e0f8;width: 140px; height: 30px;"> <a class="a"
                    href="index.php"> <span>



                        <svg style="background-color:#4667a3;border-radius:20px;padding:1px 3px;margin-right:6px;margin-top:3px"
                            fill='white' xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 320 512">
                            <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                            <path
